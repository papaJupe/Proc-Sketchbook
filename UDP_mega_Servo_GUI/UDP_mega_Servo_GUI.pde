/* Proc2
 UDP mega Servo GUI  tx/rx control w/ UDP over wifi -- Ardu;
 ...
 later could add joystick button controls using GameControlPlus lib
 */
...
public void setup() 
{
  ...
  // last 3 digits, but Ardu really needs these 4 digits
  // so I manually add this # to sketch code for remotePort
  udp.listen( true );
...
//  }     // end if
    ...
    String message = tilt.getValueS(); // values from tilt slider
