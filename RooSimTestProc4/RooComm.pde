 ...
 * Spin in place clockwise, at the input speed.
  ...
  {    // which may depend of \n at end of input
    ...
    byte[] sensor_bytes = new byte[readRequestLength];  
    ...
    //  draw loop prints result to applet window
    //    resultString += " ";  //  just the numbers with spaces
    //    for (int sensorNum = 0; sensorNum < sensors.length; sensorNum++) 
    //    {
    ...
    //from RCS: output is sensor_bytes array, but size must vary
