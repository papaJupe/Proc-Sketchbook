/*
  ...
  and a Graph2D plot. Here we have the butterfly polar plot in parametric
...
float mod = frameCount/200f; 
//this variable determines how fast with time the plot evolves
