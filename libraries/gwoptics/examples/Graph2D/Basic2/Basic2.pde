...
/**
 *  Equations that are to plot must be encapsulated into a 
...
void setup(){
  ...
  gb = new  GridBackground(new GWColour(240)); // default () works too
  gb.setGridColour(200,100,200,180,180,180);
  g.setBackground(gb);
  
  // Offset of the top left corner of the plotting area
  // to the app window corner (should not be zero in order to
