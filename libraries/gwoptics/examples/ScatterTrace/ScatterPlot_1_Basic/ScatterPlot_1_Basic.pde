/**
 * Scatter Plot Basic
 * Demonstrates a scatter plot using the gwoptics library. This randomly
 * creates 40 points
 **/
...
void setup()
{
  ...
  // Defining the main properties of the X and Y-Axes
  grph.setYAxisMin(-10);
  grph.setYAxisMax(10);
  grph.setXAxisMin(-10);
  grph.setXAxisMax(10);
  ...
  // to the applet window corner (should not be zero in order to
  // see the y-axis label
  grph.position.x = 80;
  grph.position.y = 60;
  
  // Here we create a new ScatterTrace and define the type of points 
