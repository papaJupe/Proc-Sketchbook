 ...
 *
 * <p> Once an axis object has been created it is up to the user to specify
...
public class Axis2D extends Renderable implements PConstants {
  ...
  /**
   * If set to true the axis will become logarithmic
   */
  ...
  public Axis2D(PApplet parent, int length) {
    ...
    _minorTicks = 2;  // makes 3 divisions
    _majorTickSize = 6;
    _minorTickSize = 3;
    _axisTickLblSize = 12;
    _axisLblSize = 14;
  ...
  /**
   * Internal method to draw the main axis line
   */
  ...
  protected void _generateTicks() {
    ...
    // minor ticks after the major ticks, no minor ticks are drawn before the
    // first major tick. There is probably more elegant ways of doing this, like
    ...
    // but before the next major tick
  ...
  protected void _drawAxisLabel() {
    ...
    _parent.text(String.valueOf(_label), 0, 0.3f * _fontLabel.getSize(), 0);
    _parent.popMatrix();
  }
}
