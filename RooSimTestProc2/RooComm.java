 ...
 *  revise AM 1804 to be instantiable class for comm to Roomba
    -- used by Proc .pde sketch which has user I/O code and instances
    this, calls its members for comm. Not used in __TestProc2, which
    sent bytes itself, but used by TestProc3+
 ...
 * AM: for Rev 3, serial port object set up here, port index sent by sketch
 to its constructor 
   
 * Standard lifecyle of this object
 *   RooComm rooba = new RooComm(int portID);
